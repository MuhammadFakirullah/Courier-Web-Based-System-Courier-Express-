<%-- 
    ...
    Created on : Jul 5, 2021, 4:45:09 PM
    Author     : Cool Tech
--%>
		...
		<div id="menu" style="background-color:#FFFFFF; width:100%; float:right; text-align:center">
			...
			<div id="content">
				...
				<div class="container" style="text-align: left; margin-left: 30%">
					<img src="photo/Employee.png" height="70" width="80"/><a href='EmployeeRegistration.jsp'>Employee Registration</a><br/>
					<img src="photo/Detail.jpg" height="70" width="80"/><a href='employeeListDetails.jsp'>View Employee</a><br/>
                                        <img src="photo/Detail.jpg" height="70" width="80"/><a href='searchEmployee.jsp'>Search Employee</a><br/>
				</div>
				<br/>
				<br/>
			</div>
