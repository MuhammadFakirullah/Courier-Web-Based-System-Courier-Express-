<%-- 
    Document   : homepage
    Created on : Jul 4, 2021, 3:18:01 PM
    Author     : Cool Tech
--%>
...
<html>
	...
	<body>
		...
		<div id="menu" style="background-color:#FFFFFF; height:100%; width:100%; float:right; text-align:center">
				...
				<ul class="drop_menu" align="center";>
					...
					<li><a href='#'>SERVICES</a>
						<ul>
							...
							<li><a href='TrackNTrace.jsp'>Trace & Track</a></li>
						</ul>
					</li>
					...
					<li style="float: right"><a href="#">LOG IN / SIGN UP</a>
						<ul>
							<li><a href=customerLogin.jsp>Log In</a></li>
			...
			<body>
				<br/>
				<center><h1>Welcome to the Courier Express</h1>
				<p class="ridge">
				<br/><b>Courier Express</b> is a courier express company
				that provide fast pick-ups and delivery services.<br/><br/></p></center>
				<br/>
				<img border="0" src="photo/Home.jpg" width="300px" height="200px"/>
			</body>
