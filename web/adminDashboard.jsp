<%-- 
    Document   : admin-interface-page
    Created on : Jun 4, 2021, 7:08:58 AM
    Author     : Cool Tech
--%>
    ...
    <body>
		...
		<div id="menu" style="background-color:#FFFFFF; width:100%; float:right; text-align:center">
			...
			<div id="content">
				...
				<center><h2>Welcome to the Administrator Privileges</h2>
				<p class="ridge">
				...
				<div class="container" style="text-align: left; margin-left: 30%">
					<img src="photo/Employee.png" height="70" width="80"/><a href='employeeManagement.jsp'>Employee Management</a><br/>
					<img src="photo/Detail.jpg" height="70" width="80"/><a href='parcelManagement.jsp'>Parcel Management</a><br/>
                                        <%
                                            Integer branchid = (Integer) request.getSession().getAttribute("branchid");

                                        %>
                                        <img src="photo/Salary.png" height="70" width="80"/><a href='adminProfile.jsp?branchID=<%=branchid %>'>Profile</a><br/>
                                        <img src="photo/Salary.png" height="70" width="80"/><a href='homepage.jsp'>Log out</a><br/>
                                        <img src="photo/Detail.jpg" height="70" width="80"/><a href='adminProfileDelete.jsp?branchID=<%=branchid %>'>Delete Account</a><br/>
				</div>
				<br/>
				<br/>
			</div>
